  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.halal-snoep.nl/blog/snoep-uit-amerika"/>
      ...
      <div className="pagecontent">
        <div id="pageheader6">
            <ul class="breadcrumb">
                ...
                <li>Snoep uit Amerika</li>
            </ul>

            <section>
                <h1>Snoep uit Amerika</h1>
            </section>
            <section>
            </section>
        </div>
