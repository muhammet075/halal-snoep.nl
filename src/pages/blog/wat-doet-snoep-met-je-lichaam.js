...
export default function WatDoetSnoepMetJeLichaam() {
  useEffect(() => {
  });
  ...
  return (
    <>
      <Head>
        <title>Wat doet snoep met je lichaam?</title>
      ...
      <div className="pagecontent">
        <div id="pageheader9">
            <ul class="breadcrumb">
                ...
                <li>Wat doet snoep met je lichaam?</li>
            </ul>

            <section>
                <h1>Wat doet snoep met je lichaam?</h1>
            </section>
            <section>
            </section>
        </div>
