...
export default function SnoepUitDeJaren90En80() {
  useEffect(() => {
  });
  ...
  return (
    <>
      <Head>
        <title>Snoep uit de jaren 90 en 80</title>
        ...
        <meta property="og:url" content="https://www.halal-snoep.nl/blog/snoep-uit-de-jaren-90-en-80"/>
      ...
      <div className="pagecontent">
        <div id="pageheader4">
            <ul class="breadcrumb">
                ...
                <li>Snoep uit de jaren 90 en 80</li>
            </ul>

            <section>
                <h1>Snoep uit de jaren 90 en 80</h1>
            </section>
            <section>
            </section>
        </div>
