...
export default function IsSnoepSlechtVoorJe() {
  useEffect(() => {
  });
  ...
  return (
    <>
      <Head>
        <title>Is snoep slecht voor je?</title>
        ...
        <meta property="og:url" content="https://www.halal-snoep.nl/blog/is-snoep-slecht-voor-je/"/>
      ...
      <div className="pagecontent">
        <div id="pageheader1">
            <ul class="breadcrumb">
                ...
                <li>Is snoep slecht voor je?</li>
            </ul>

            <section>
                <h1>Is snoep slecht voor je?</h1>
            </section>
            <section>
            </section>
        </div>
